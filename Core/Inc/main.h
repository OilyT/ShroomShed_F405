...
#define PUSH_BUTTON_Pin GPIO_PIN_14
#define PUSH_BUTTON_GPIO_Port GPIOB
#define ENC_BUTTON_Pin GPIO_PIN_15
#define ENC_BUTTON_GPIO_Port GPIOB
#define ENC_CH_B_Pin GPIO_PIN_6
#define ENC_CH_B_GPIO_Port GPIOC
#define ENC_CH_A_Pin GPIO_PIN_7
#define ENC_CH_A_GPIO_Port GPIOC
#define ST7735_CS_Pin GPIO_PIN_15
#define ST7735_CS_GPIO_Port GPIOA
#define H_PWM_Pin GPIO_PIN_8
#define H_PWM_GPIO_Port GPIOB
